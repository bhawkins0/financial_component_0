task({:test => :environment}) do
  new_customers = CSV.read('/workspace/financial_component_0/lib/tasks/f_accounts2.csv', { :col_sep => ';' })
  CSV.foreach('/workspace/financial_component_0/lib/tasks/f_accounts2.csv', { :col_sep => ';' }) { |row| 
